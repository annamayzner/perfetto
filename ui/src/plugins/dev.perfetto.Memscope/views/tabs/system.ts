...
function buildSystemTimeSeries(
  ...
  const series: LineChartSeries[] = [
    {name: 'Anon', points: anonPts},
    {name: 'Page cache', points: filePts},
    {name: 'Shmem', points: shmemPts},
    {name: 'Buffers', points: buffersPts},
    {name: 'Slab', points: slabPts},
    {name: 'PageTables', points: pageTablesPts},
    {name: 'KernelStack', points: kernelStackPts},
    {name: 'Zram', points: zramPts},
    {name: 'MemFree', points: freePts},
    {name: 'Unaccounted', points: unaccountedPts},
  ];
  if (hasDmaHeap) {
