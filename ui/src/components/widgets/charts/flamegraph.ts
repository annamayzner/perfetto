...
export interface FlameChartSegment {
  readonly name: string;
  readonly value: number;
  readonly cssColor: string;
  readonly children: readonly FlameChartSegment[];
...
export interface FlameChartSimpleAttrs {
  readonly data: FlameChartSegment;
  ...
  readonly onSegmentClick?: (seg: FlameChartSegment) => void;
...
interface PlacedSegment {
  readonly seg: FlameChartSegment;
...
export function FlamegraphChart(): m.Component<FlameChartSimpleAttrs> {
  ...
  return {
    view({attrs}: m.Vnode<FlameChartSimpleAttrs>) {
